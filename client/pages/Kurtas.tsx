...
export default function Kurtas() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative h-64 bg-gradient-to-r from-green-700/90 to-emerald-800/90 flex items-center">
        <div className="absolute inset-0 bg-gradient-to-br from-green-600/20 to-emerald-700/20" />
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            ...
            <p className="text-green-100 text-lg">
              Comfortable and elegant traditional kurtas for every occasion. 
              Perfect blend of comfort and style in premium fabrics.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="pb-4 border-t">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {["Cotton", "Silk", "Linen", "Khadi", "Handloom"].map((fabric) => (
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {["Regular", "Straight", "A-Line", "Pathani", "Nehru"].map((style) => (
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {["Casual", "Festival", "Wedding", "Office", "Party"].map((occasion) => (
